...
static void sep0611_i2c_init(struct sep0611_i2c *i2c)
{
	...
	//by lwl
#ifdef I2C_ENABLE_IN_INIT
	/* Disable the adapter */
	writew(1, i2c->base + I2C_ENABLE);	//to solve i2c time_out in ondemand mode
#endif
	//by lwl
}
...
/*************add by zy**************/
// by lwl
#ifdef CONFIG_CPU_FREQ_I2C_TIME_OUT
#ifdef CONFIG_CPU_FREQ
// by lwl
	#define I2C_ENABLE_IN_INIT
#ifdef CONFIG_CPU_FREQ_LESS_DEVICE
	#define SEP0611_I2C_NUM 1
#else
	#define SEP0611_I2C_NUM 3
#endif
// by lwl
struct notifier_block   sep0611_i2c_freq_transition;
static int sep0611_i2c_cpufreq_transition(struct notifier_block *nb, unsigned long val, void *data)
{
//	int i;

printk("%s\n",__func__);
//	for(i=0; i < SEP0611_I2C_NUM; i++){
//		if(i2cs[i])
...
static inline int sep0611_i2c_cpufreq_register(void)
{
printk("%s\n",__func__);
    sep0611_i2c_freq_transition.notifier_call = sep0611_i2c_cpufreq_transition;
    return cpufreq_register_notifier(&sep0611_i2c_freq_transition, CPUFREQ_TRANSITION_NOTIFIER);
}

static inline void sep0611_i2c_cpufreq_deregister(void)
{
    cpufreq_unregister_notifier(&sep0611_i2c_freq_transition, CPUFREQ_TRANSITION_NOTIFIER);
}
...
static void __exit i2c_adap_sep0611_exit(void)
{
	...
	/*************add by zy**************/
	sep0611_i2c_cpufreq_deregister();
	/*************add by zy**************/
}
