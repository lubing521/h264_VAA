...
static void if_sdio_powerup()
{
	printk(KERN_INFO "marvell sd8686 wifi: power up.\n");
	sep0611_gpio_cfgpin(SEP0611_WIFI_RST,SEP0611_GPIO_IO);
	sep0611_gpio_dirpin(SEP0611_WIFI_RST,SEP0611_GPIO_OUT);
	sep0611_gpio_setpin(SEP0611_WIFI_RST,GPIO_HIGH);
}

static void if_sdio_powerdown()
{
	printk(KERN_INFO "marvell sd8686 wifi: power down.\n");
	sep0611_gpio_cfgpin(SEP0611_WIFI_RST,SEP0611_GPIO_IO);
	sep0611_gpio_dirpin(SEP0611_WIFI_RST,SEP0611_GPIO_OUT);
