...
void musb_platform_enable(struct musb *musb)
{
    ...
    SEP0611_INT_DISABLE(SEP0611_USB_OTG_DET_INTSRC);
    sep0611_gpio_setirq(SEP0611_USB_OTG_DET, DOWN_TRIG | UP_TRIG);
    mdelay(2);
    //sep0611_gpio_clrirq(SEP0611_USB_OTG_DET);

    SEP0611_INT_ENABLE(SEP0611_USB_OTG_DET_INTSRC);

    rc = request_irq(SEP0611_USB_OTG_DET_INTSRC, usb3343_irq,
		    	IRQF_DISABLED|IRQF_TRIGGER_FALLING, "usb3343", NULL);
    if(rc)
    {
	    printk("USB PHY 3343 request irq failed!!!\n");
    }
#endif
    ...
    sep0611_gpio_cfgpin(SEP0611_OTG_DRV, SEP0611_GPIO_IO);        
    sep0611_gpio_dirpin(SEP0611_OTG_DRV, SEP0611_GPIO_OUT);
    sep0611_gpio_setpin(SEP0611_OTG_DRV, 0);
    msleep(15);  
    ...
    //sep0611_gpio_setpin(SEP0611_HUB_REST, 0);
    //msleep(15); 
    //sep0611_gpio_cfgpin(SEP0611_HUB_REST, SEP0611_GPIO_IO);       
    //sep0611_gpio_dirpin(SEP0611_HUB_REST, SEP0611_GPIO_OUT);
    //sep0611_gpio_setpin(SEP0611_HUB_REST, 1);
#endif
...
static void hp_task_func(unsigned long data)
{
        disable_irq(SEP0611_USB_OTG_DET_INTSRC);
	sep0611_gpio_cfgpin(SEP0611_PHY_RST, SEP0611_GPIO_IO);          
	sep0611_gpio_dirpin(SEP0611_PHY_RST, SEP0611_GPIO_OUT);
	sep0611_gpio_setpin(SEP0611_PHY_RST, 0);
	...
	sep0611_gpio_setpin(SEP0611_PHY_RST, 1);
        ...
        enable_irq(SEP0611_USB_OTG_DET_INTSRC);
	musb_platform_try_idle(test_musb, 0);
}
