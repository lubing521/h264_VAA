...
int main(int argc,char* argv[])
{
    ...
    gets(szKey);
    printf("the key you input is: %s input the message you want to encipher: \n",szKey);
    BlowfishKeyInit(szKey,strlen(szKey));
    gets(szMessage);
    printf("before encipher,the message is: %s \n",szMessage);
    int i;
    ...
    printf("the enciphered message is:");
    for (i=0;i<strlen(szMessage);i++)
        printf("%x",szMessage[i]);
    printf(" \n");
    printf("decipher . . . \n");
    for (i=0;i<len;i+=8)
    {
