...
#define CONFIG_SYS_TEXT_BASE	0x41400000
...
//#define CONFIG_BOOTARGS  	"root=/dev/nfs rw nfsroot=192.168.0.3:/nfs ip=192.168.0.2:192.168.0.3:192.168.0.1:255.255.255.0:sep0611:eth0:off console=ttyS0,115200 mem=256mb" 
#define CONFIG_BOOTARGS "root=/dev/ram0 rw console=ttyS0,115200 mem=64mb"
//#define CONFIG_BOOTARGS "root=/dev/ram0 rw console=ttyS0,115200 mem=64mb initrd=0x41000000,0x800000 init=/linuxrc"
//#define CONFIG_BOOTARGS "root=/dev/mtdblock4 console=ttyS0,115200 rootfstype=yaffs mem=208mb"
//#define CONFIG_BOOTARGS     "set bootargs console=ttyS0,115200 ubi.mtd=2 root=ubi0_0 rootfstype=ubifs mem=64mb"
...
//#define CONFIG_BOOTCOMMAND  "nand read 0x40008000 0x400000 0x300000; bootm 0x40008000"
//#define CONFIG_BOOTCOMMAND  "mtdparts default; nand read 0x41000000 0xe00000 0x400000; nand read 0x40008000 0x400000 0x300000; bootm 0x40008000;" 
//#define CONFIG_BOOTCOMMAND  "set serverip 192.168.0.3;tftp 40008000 uImage;bootm;"
...
#define CONFIG_UBOOT_BASE		0x41400000
